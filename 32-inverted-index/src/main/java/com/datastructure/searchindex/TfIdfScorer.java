...
public class TfIdfScorer implements Scorer {
    ...
    public double score(int termFrequency, int documentFrequency, int documentCount) {
        // TODO 3: 위 javadoc 의 식 하나다. 셋 중 하나라도 0 이하이면 0 점으로 빠져나온다.
        //
        // 그 방어가 없으면 df 가 0 일 때 무한대가 나오고, 무한대는 예외 없이 정렬을 통과한다.
        throw new UnsupportedOperationException("TODO 3: score");
    }
