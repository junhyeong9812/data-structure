...
public class StandardAnalyzer implements Analyzer {
    ...
    public List<String> analyze(String text) {
        // TODO 2: 자르고, 내리고, 걸러서 목록으로 낸다. 위 javadoc 의 순서와 로케일이 계약이다.
        //
        // 걷어낸 자리를 빈칸으로 메우지 않는다는 점을 알고 넘어가라.
        // 위치는 걸러낸 뒤 목록에서의 인덱스이고, 그래서 불용어를 사이에 낀 원문은
        // 그 불용어를 뺀 구문으로 물어야 붙어 있는 것으로 보인다. 답이 아니라 이 설계의 뜻이다.
        throw new UnsupportedOperationException("TODO 2: analyze");
    }
