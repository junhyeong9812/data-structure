...
class PopTest {
    ...
    class SinglyLinkedListTest {
        ...
        class Miscellaneous {
            ...
            @Test
            @DisplayName("26. null 요소를 저장할 수 있다")
            void test26_nullElement() {
            ...
            @Test
            @DisplayName("27. 단일 요소 리스트에서 삭제 후 빈 리스트가 된다")
            void test27_removeFromSingleElementList() {
                // TODO: 엣지 케이스 테스트
                // list.addLast(1);
                // list.removeFirst();
                // assertThat(list.isEmpty()).isTrue();
    ...
    class DoublyLinkedListTest {
        ...
        @Test
        @DisplayName("29. 양방향 순회가 가능하다")
        void test29_bidirectionalTraversal() {
            // TODO: 양방향 순회 테스트
            // list.addLast(1);
            // list.addLast(2);
            // list.addLast(3);
            // 뒤에서 앞으로 순회하는 메서드 구현 후 테스트
        }

        @Test
        @DisplayName("30. prev 포인터가 올바르게 설정된다")
        void test30_prevPointerCorrect() {
            // TODO: prev 포인터 테스트
            // list.addLast(1);
            // list.addLast(2);
            // list.addLast(3);
            // 내부 노드의 prev가 올바른지 검증
        }
    }
}
