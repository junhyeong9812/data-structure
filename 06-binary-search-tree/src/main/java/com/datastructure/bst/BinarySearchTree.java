...
public class BinarySearchTree<K extends Comparable<K>, V> implements SortedMap<K, V> {
     ...
     *
     * TODO(01): 구현하라. key 가 null 이면 null 을 반환한다.
     */
     ...
     *   - 새 노드는 항상 잎(leaf)으로 붙는다. 붙일 자리를 찾으려면 그 **부모**를 알아야 한다.
     *
    ...
    public V remove(K key) {
        throw new UnsupportedOperationException("TODO(03): remove");
    }

    /**
     * 가장 작은 키. 비었으면 NoSuchElementException.
     *
     * TODO(04): 구현하라. 한 방향으로만 내려가면 된다.
     */
    @Override
    public K firstKey() {
        throw new UnsupportedOperationException("TODO(04): firstKey");
    }

    /** TODO(05): 구현하라. firstKey 의 대칭이다. */
    @Override
    public K lastKey() {
        throw new UnsupportedOperationException("TODO(05): lastKey");
    }
    ...
    public K floorKey(K key) {
        throw new UnsupportedOperationException("TODO(06): floorKey");
    }

    /** TODO(07): 구현하라. floorKey 의 대칭이다. */
    @Override
    public K ceilingKey(K key) {
        throw new UnsupportedOperationException("TODO(07): ceilingKey");
    }
    ...
    public Iterable<K> keys() {
        throw new UnsupportedOperationException("TODO(08): keys");
    }
     ...
     *
     * TODO(09): 구현하라. 답이 k 개면 O(log n + k) 를 지향한다.
     */
    @Override
    public Iterable<K> keysInRange(K from, K to) {
        throw new UnsupportedOperationException("TODO(09): keysInRange");
    }
}
